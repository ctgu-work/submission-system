...
//
//    @Query(value = "SELECT s.specialist_id as specialistId,a.name,c.category,a.phone_number,a.user_id,COUNT(*) as count,c.status FROM review_paper s INNER JOIN specialist c ON\n" +
