...
import com.ctgu.contributionsystem.filter.JwtFilter;
import com.ctgu.contributionsystem.shiro.AdminRealm;
import com.ctgu.contributionsystem.shiro.MyRealm;
import com.ctgu.contributionsystem.shiro.UserModularRealmAuthenticator;
...
//    @DependsOn("lifecycleBeanPostProcessor")
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/user/showInfo/**", "anon");
        filterChainDefinitionMap.put("/user/showIndex/**", "anon");
